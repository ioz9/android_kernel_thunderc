...
#define CONFIG_USB_GADGET_LG_MTP_DRIVER 1
...
#define CONFIG_RMNET_SMD_CTL_CHANNEL "control"
...
#define CONFIG_LOCALVERSION "$(KERNEL_LOCAL_VERSION)-plague"
...
#define CONFIG_RMNET_SMD_DATA_CHANNEL "data"
